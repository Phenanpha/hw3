...
import 'package:hw3/models/todo_item.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
                ...
                child: Padding(
                    ...
                    child: Column(children: [
                      ...
                      [Padding(
                        ...
                        child: Container(decoration: BoxDecoration(border: Border.all(color: Colors.black,style: BorderStyle.none),borderRadius: BorderRadius.circular(15.0),color: Colors.pink.shade100),
                        ...
                        Column(children: [Padding(
                          padding: const EdgeInsets.all(3.0),
                          child: Container(decoration: BoxDecoration(border: Border.all(color: Colors.black,style: BorderStyle.none),borderRadius: BorderRadius.circular(15.0),color: Colors.lightBlue.shade100),
    ...
    return Scaffold(appBar: AppBar(title: Center(child: const Text('Photo Albums',))),body: body);
  }
}